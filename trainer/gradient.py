...
class GradientTrainer(BaseTrainer):
    ...
    def get_adversarial_examples(self, args: ClassifierArgs, batch: Tuple) -> Tuple[torch.Tensor]:
...
class EmbeddingLevelGradientTrainer(GradientTrainer):
    ...
    @staticmethod
    def delta_initial(args: ClassifierArgs, embedding: torch.Tensor, attention_mask: torch.Tensor) -> torch.Tensor:
    ...
    @staticmethod
    def delta_update(args: ClassifierArgs, embedding: torch.Tensor, delta: torch.Tensor, delta_grad: torch.Tensor) -> torch.Tensor:
        if args.adv_norm_type == "l2":
    ...
    def get_adversarial_examples(self, args: ClassifierArgs, batch: Tuple) -> Tuple:
