...
from utils.utils import collate_fn, xlnet_collate_fn
...
class HotflipTrainer(TokenLevelGradientTrainer):
    ...
    def get_adversarial_examples(self, args: ClassifierArgs, batch: Tuple[torch.Tensor]) -> Tuple[torch.Tensor]:
    ...
    def train(self, args: ClassifierArgs, batch: Tuple[torch.Tensor]) -> float:
